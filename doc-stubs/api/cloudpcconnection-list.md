...
Get a list of the [cloudPcConnection](../resources/cloudpcconnection.md) objects and their properties.
...
-->
``` http
GET https://graph.microsoft.com/beta/cloudPcConnections
```
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.management.services.api.cloudPcConnection)"
}
-->
``` http
HTTP/1.1 200 OK
