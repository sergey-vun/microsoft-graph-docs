...
<!-- {
  "blockType": "request",
  "name": "create_windowsprotectionstate_from_windowsprotectionstates"
}
-->
``` http
POST https://graph.microsoft.com/beta/windowsProtectionStates
